...
class Designation extends CI_Controller {
	...
	{
		$data['page']="designation/add_Designation";
	...
	public function add(){
		...
		if ($this->form_validation->run() == FALSE)
        {
			...
			redirect('designation/Designation/Lists');
		//}	
	}
