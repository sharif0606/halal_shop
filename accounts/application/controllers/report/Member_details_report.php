...
class Member_details_report extends CI_Controller {
	...
	{
	    $data['page']="report/member_report/member_details_report";
	...
	public function mdr(){
		...
		$mainContent=$this->load->view('report/member_report/mdr', $data, true);
