...
class Loan_report extends CI_Controller {
	...
	{
		$data['page']="report/loan_report/lr";
	...
	public function glrm(){
		...
		$mainContent=$this->load->view('report/loan_report/glrm', $data, true);
	...
	public function glrd(){
		...
		$mainContent=$this->load->view('report/loan_report/glrd', $data, true);
	...
	public function glrbd(){
		...
		$mainContent=$this->load->view('report/loan_report/lrbd', $data, true);
