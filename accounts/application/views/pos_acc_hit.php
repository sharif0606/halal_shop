...
<?php endif?>
<form method="get" action="<?= base_url('cornjob/submit_all');?>" onsubmit="return confirm('Are you sure? if you transfer amount POS to account section you cannot change it. So please check again then submit.')">
    <div class="row">
