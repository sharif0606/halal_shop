	...
	<ul class="nav nav-list">
		...
		<li class="hover">
			<a href="#" class="dropdown-toggle">
				...
				<ul class="submenu">
					<li class="">
						<a href="<?= base_url();?>db_backup/Backup">
				...
				<li>
					...
					<ul class="submenu">
						<li class="<?php //if(!in_array("vEntry", $accArea) && $sup!=1){ echo "hidden"; } ?>  hover">
							<a href="<?= base_url();?>accounts/debit_voucher_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Payment Voucher
							</a>
						...
						<li class="<?php //if(!in_array("vEntry", $accArea) && $sup!=1){ echo "hidden"; } ?>  hover">
							<a href="<?= base_url();?>accounts/credit_voucher_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Receive Voucher
							</a>
						...
						<li class="<?php //if(!in_array("vEntry", $accArea) && $sup!=1){ echo "hidden"; } ?>  hover">
							<a href="<?= base_url();?>accounts/journal_voucher_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Journal Voucher
							</a>
		...
		<li class="hover">
			...
			<b class="arrow"></b>
				...
				<li class="<?php //if(!in_array("vList", $accArea) && $sup!=1){ echo "hidden"; } ?> hover" >
					<a href="<?= base_url();?>accounts/trial_balance">
						<i class="menu-icon fa fa-caret-right"></i>
						Trial Balance
					</a>
					<b class="arrow"></b>
				...
				<li class="<?php //if(!in_array("vList", $accArea) && $sup!=1){ echo "hidden"; } ?> hover" >
					<a href="<?= base_url();?>report/acc_head_report">
						<i class="menu-icon fa fa-caret-right"></i>
						Account Head Report
					</a>
					<b class="arrow"></b>
				...
				<li class="<?php //if(!in_array("vList", $accArea) && $sup!=1){ echo "hidden"; } ?> hover">
					<a href="<?= base_url();?>report/profit_loss_report">
						<i class="menu-icon fa fa-caret-right"></i>
						Profit Loss Report
					</a>
					<b class="arrow"></b>
				...
				<li class="<?php //if(!in_array("vList", $accArea) && $sup!=1){ echo "hidden"; } ?> hover">
					<a href="<?= base_url();?>report/receipt_payment_report">
						<i class="menu-icon fa fa-caret-right"></i>
				...
				<li class="<?php //if(!in_array("vList", $accArea) && $sup!=1){ echo "hidden"; } ?> hover">
					<a href="<?= base_url();?>report/balance_sheet_report">
						<i class="menu-icon fa fa-caret-right"></i>
