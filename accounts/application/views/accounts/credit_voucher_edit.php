					...
					<div class="widget-content padding">
						...
						<div class="form-group" style="margin-bottom: 0px;">
							...
							<ul class="list-inline">
								<li><a href="<?php echo base_url();?>accounts/credit_voucher_list" class="text-muted small">Receive Voucher List</a> </li> |
								<li><a href="<?php echo base_url();?>accounts/credit_voucher_entry" class="text-muted small">Receive Voucher Create</a> </li>
							</ul>
							</div>
