		...
		<div class="row">
			<div class="col-sm-12">
				<div class="widget" style="min-height:500px;">
					<div class="widget-content padding">
						...
						<div class="form-group" style="margin-bottom: 0px;">
							...
							<ul class="list-inline">
								<li><a href="<?php echo base_url();?>accounts/debit_voucher_list" class="text-muted small">Payment Voucher List</a> </li> |
								<li><a href="<?php echo base_url();?>accounts/debit_voucher_entry" class="text-muted small">Payment Voucher Create</a> </li>
							</ul>
							</div>
					...
					<?= form_open('accounts/debit_voucher_edit/'.$debit_voucher_row_edit['id'],'id="detvoucherform" name="detvoucherform"'); ?>
